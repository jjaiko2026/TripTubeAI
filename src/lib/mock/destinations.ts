...
export const DESTINATIONS: DestinationProfile[] = [
  ...
  },
  {
    ...
    popularity: 94,
    activities: [
      { time: "", title: "경복궁 & 북촌한옥마을", description: "조선 왕실의 정취와 전통 한옥 골목을 함께 둘러보는 코스", tags: ["culture"], area: "도심" },
      { time: "", title: "인사동 전통거리", description: "공예품 갤러리와 전통 찻집이 늘어선 거리 산책", tags: ["culture", "shopping"], area: "도심" },
      { time: "", title: "광장시장 먹거리 투어", description: "빈대떡과 마약김밥으로 유명한 서울 대표 재래시장", tags: ["food"], area: "도심" },
      { time: "", title: "남산서울타워 야경", description: "케이블카를 타고 올라가 서울 전경을 한눈에 담는 야경 명소", tags: ["healing"], area: "도심" },
      { time: "", title: "홍대 거리 & 연남동 카페골목", description: "젊음의 거리에서 즐기는 개성 있는 쇼핑과 감성 카페", tags: ["shopping", "cafe"], area: "홍대" },
      { time: "", title: "여의도 한강공원 피크닉", description: "한강을 바라보며 즐기는 여유로운 피크닉과 자전거 라이딩", tags: ["healing", "activity"], area: "여의도" },
      { time: "", title: "강남 가로수길 & 코엑스", description: "트렌디한 편집숍과 대형 쇼핑몰을 함께 즐기는 코스", tags: ["shopping"], area: "강남" },
      { time: "", title: "이태원 & 경리단길 맛집 투어", description: "이국적인 분위기 속 다양한 세계 음식을 즐기는 거리", tags: ["food"], area: "이태원" },
    ],
  },
  {
    id: "busan",
