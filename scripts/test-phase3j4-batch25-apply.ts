/**
 * PHASE 3-J-4 — 25건 상세정보 배치 반영 (INSERT/UPDATE 있음, 음식점/숙박 없음).
 *
 * 실행: dotenv -e .env.local -- tsx scripts/test-phase3j4-batch25-apply.ts
 *
 * scripts/test-phase3j3-batch25-apply.ts와 골격 동일 — place 단위 실패 격리
...
// PHASE 3-J-4 PREVIEW에서 확정한 25건 그대로(37건 미보유 중 지역x타입 버킷 비율 유지 선정,
// 나머지 12건은 3-J-5로 이월). 숙박(32)/음식점(39) 잔여 0건 — 이번 배치는 관광지(12)/문화시설(14)뿐.
const TEST_TARGETS = [
  { regionCode: "KR-JEJU-SEOGWIPO", regionNameKo: "서귀포시", expectedAreaCode: "39", expectedSigunguCode: "3" as string | null, contentTypeId: "12", contentId: "3026711", name: "가시리국산화풍력발전단지" },
  { regionCode: "KR-JEJU-SEOGWIPO", regionNameKo: "서귀포시", expectedAreaCode: "39", expectedSigunguCode: "3" as string | null, contentTypeId: "12", contentId: "1885754", name: "가시오름" },
  { regionCode: "KR-JEJU-SEOGWIPO", regionNameKo: "서귀포시", expectedAreaCode: "39", expectedSigunguCode: "3" as string | null, contentTypeId: "12", contentId: "1890152", name: "거린사슴" },
  { regionCode: "KR-JEJU-SEOGWIPO", regionNameKo: "서귀포시", expectedAreaCode: "39", expectedSigunguCode: "3" as string | null, contentTypeId: "12", contentId: "2779522", name: "고산일과해안도로" },
  { regionCode: "KR-JEJU-SEOGWIPO", regionNameKo: "서귀포시", expectedAreaCode: "39", expectedSigunguCode: "3" as string | null, contentTypeId: "12", contentId: "1918984", name: "구두리오름" },
  { regionCode: "KR-JEJU-SEOGWIPO", regionNameKo: "서귀포시", expectedAreaCode: "39", expectedSigunguCode: "3" as string | null, contentTypeId: "14", contentId: "1883815", name: "박물관은살아있다 제주" },
  { regionCode: "KR-JEJU-SEOGWIPO", regionNameKo: "서귀포시", expectedAreaCode: "39", expectedSigunguCode: "3" as string | null, contentTypeId: "14", contentId: "1939093", name: "삼매봉도서관" },
  { regionCode: "KR-JEJU-SEOGWIPO", regionNameKo: "서귀포시", expectedAreaCode: "39", expectedSigunguCode: "3" as string | null, contentTypeId: "14", contentId: "130193", name: "서귀포문화원" },
  { regionCode: "KR-JEJU-SEOGWIPO", regionNameKo: "서귀포시", expectedAreaCode: "39", expectedSigunguCode: "3" as string | null, contentTypeId: "14", contentId: "596964", name: "세계자동차&피아노 박물관" },
  { regionCode: "KR-JEJU-SEOGWIPO", regionNameKo: "서귀포시", expectedAreaCode: "39", expectedSigunguCode: "3" as string | null, contentTypeId: "14", contentId: "1220821", name: "세계조가비박물관" },
  { regionCode: "KR-SEOUL-CITY", regionNameKo: "서울", expectedAreaCode: "1", expectedSigunguCode: null as string | null, contentTypeId: "12", contentId: "809490", name: "강서습지생태공원" },
  { regionCode: "KR-SEOUL-CITY", regionNameKo: "서울", expectedAreaCode: "1", expectedSigunguCode: null as string | null, contentTypeId: "12", contentId: "2373204", name: "경성 부민관 폭탄 의거지" },
  { regionCode: "KR-SEOUL-CITY", regionNameKo: "서울", expectedAreaCode: "1", expectedSigunguCode: null as string | null, contentTypeId: "12", contentId: "1604784", name: "경희궁 흥화문" },
  { regionCode: "KR-SEOUL-CITY", regionNameKo: "서울", expectedAreaCode: "1", expectedSigunguCode: null as string | null, contentTypeId: "14", contentId: "130511", name: "간송미술관(서울 보화각)" },
  { regionCode: "KR-SEOUL-CITY", regionNameKo: "서울", expectedAreaCode: "1", expectedSigunguCode: null as string | null, contentTypeId: "14", contentId: "2591878", name: "갤러리 구루지" },
  { regionCode: "KR-SEOUL-CITY", regionNameKo: "서울", expectedAreaCode: "1", expectedSigunguCode: null as string | null, contentTypeId: "14", contentId: "130581", name: "갤러리 마노" },
  { regionCode: "KR-SEOUL-CITY", regionNameKo: "서울", expectedAreaCode: "1", expectedSigunguCode: null as string | null, contentTypeId: "14", contentId: "130568", name: "갤러리 미즈" },
  { regionCode: "KR-SEOUL-CITY", regionNameKo: "서울", expectedAreaCode: "1", expectedSigunguCode: null as string | null, contentTypeId: "14", contentId: "2739448", name: "공근혜갤러리" },
  { regionCode: "KR-JEJU-JEJUSI", regionNameKo: "제주시", expectedAreaCode: "39", expectedSigunguCode: "4" as string | null, contentTypeId: "12", contentId: "128443", name: "교래 삼다수마을" },
  { regionCode: "KR-JEJU-JEJUSI", regionNameKo: "제주시", expectedAreaCode: "39", expectedSigunguCode: "4" as string | null, contentTypeId: "12", contentId: "1621059", name: "구시물" },
  { regionCode: "KR-JEJU-JEJUSI", regionNameKo: "제주시", expectedAreaCode: "39", expectedSigunguCode: "4" as string | null, contentTypeId: "12", contentId: "2738659", name: "구엄포구" },
  { regionCode: "KR-JEJU-JEJUSI", regionNameKo: "제주시", expectedAreaCode: "39", expectedSigunguCode: "4" as string | null, contentTypeId: "12", contentId: "2765234", name: "궷물오름" },
  { regionCode: "KR-JEJU-JEJUSI", regionNameKo: "제주시", expectedAreaCode: "39", expectedSigunguCode: "4" as string | null, contentTypeId: "12", contentId: "1960087", name: "귤림서원" },
  { regionCode: "KR-JEJU-JEJUSI", regionNameKo: "제주시", expectedAreaCode: "39", expectedSigunguCode: "4" as string | null, contentTypeId: "14", contentId: "130856", name: "제주돌마을공원" },
  { regionCode: "KR-JEJU-JEJUSI", regionNameKo: "제주시", expectedAreaCode: "39", expectedSigunguCode: "4" as string | null, contentTypeId: "14", contentId: "3066924", name: "제주웰컴센터" },
] as const;
...
async function main() {
  ...
  console.log("=== PHASE 3-J-4 실행 시작 (place 단위 실패 격리, 25건 최대 처리) ===\n");
