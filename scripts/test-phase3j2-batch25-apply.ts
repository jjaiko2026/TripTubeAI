/**
 * PHASE 3-J-2 — 25건 상세정보 배치 반영 (INSERT/UPDATE 있음, 음식점/숙박 없음).
 *
 * 실행: dotenv -e .env.local -- tsx scripts/test-phase3j2-batch25-apply.ts
 *
 * scripts/test-phase3j1-batch20-apply.ts와 골격이 동일하다 — place 단위 실패 격리
 * (detailCommon2/detailIntro2를 독립 시도, 한쪽이 실패해도 다른 쪽은 계속 진행), place당
 * 정확히 1건만 UPDATE 대상(UNIQUE(external_source, external_content_id)로 구조적 보장).
 *
 * 이번 배치에는 Phase 3-D에서 발견된 좌표 오류 레코드(계남근린공원, contentId=2611568,
 * lat=19.69/lng=117.99)가 포함돼 있다 — validateCoordinate가 실제로 invalidCoordinate를
 * 잡아내는지 실데이터로 확인하는 목적, 좌표는 절대 수정/삭제하지 않는다(UPDATE 대상
 * 컬럼에 애초에 lat/lng이 없음).
 */
export {};
...
// PHASE 3-J-2 PREVIEW에서 확정한 25건 그대로.
const TEST_TARGETS = [
  { regionCode: "KR-SEOUL-CITY", regionNameKo: "서울", expectedAreaCode: "1", expectedSigunguCode: null as string | null, contentTypeId: "12", contentId: "2591797", name: "고척근린공원" },
  { regionCode: "KR-SEOUL-CITY", regionNameKo: "서울", expectedAreaCode: "1", expectedSigunguCode: null as string | null, contentTypeId: "14", contentId: "130920", name: "경희대학교 자연사박물관" },
  { regionCode: "KR-JEJU-JEJUSI", regionNameKo: "제주시", expectedAreaCode: "39", expectedSigunguCode: "4", contentTypeId: "12", contentId: "1884191", name: "가마오름" },
  { regionCode: "KR-JEJU-JEJUSI", regionNameKo: "제주시", expectedAreaCode: "39", expectedSigunguCode: "4", contentTypeId: "14", contentId: "2031663", name: "김만덕기념관" },
  { regionCode: "KR-JEJU-SEOGWIPO", regionNameKo: "서귀포시", expectedAreaCode: "39", expectedSigunguCode: "3", contentTypeId: "12", contentId: "138185", name: "금호리조트 제주" },
  { regionCode: "KR-JEJU-SEOGWIPO", regionNameKo: "서귀포시", expectedAreaCode: "39", expectedSigunguCode: "3", contentTypeId: "14", contentId: "130474", name: "제주민속촌" },
  { regionCode: "KR-SEOUL-CITY", regionNameKo: "서울", expectedAreaCode: "1", expectedSigunguCode: null as string | null, contentTypeId: "12", contentId: "2591792", name: "개봉유수지 생태공원" },
  { regionCode: "KR-SEOUL-CITY", regionNameKo: "서울", expectedAreaCode: "1", expectedSigunguCode: null as string | null, contentTypeId: "14", contentId: "130446", name: "가회민화박물관" },
  { regionCode: "KR-JEJU-JEJUSI", regionNameKo: "제주시", expectedAreaCode: "39", expectedSigunguCode: "4", contentTypeId: "12", contentId: "2759120", name: "고스트타운" },
  { regionCode: "KR-JEJU-JEJUSI", regionNameKo: "제주시", expectedAreaCode: "39", expectedSigunguCode: "4", contentTypeId: "14", contentId: "2811110", name: "훈데르트바서파크" },
  { regionCode: "KR-JEJU-SEOGWIPO", regionNameKo: "서귀포시", expectedAreaCode: "39", expectedSigunguCode: "3", contentTypeId: "12", contentId: "127051", name: "고근산" },
  { regionCode: "KR-JEJU-SEOGWIPO", regionNameKo: "서귀포시", expectedAreaCode: "39", expectedSigunguCode: "3", contentTypeId: "14", contentId: "988207", name: "서귀포천문과학문화관" },
  { regionCode: "KR-SEOUL-CITY", regionNameKo: "서울", expectedAreaCode: "1", expectedSigunguCode: null as string | null, contentTypeId: "12", contentId: "128961", name: "강변스파랜드" },
  { regionCode: "KR-SEOUL-CITY", regionNameKo: "서울", expectedAreaCode: "1", expectedSigunguCode: null as string | null, contentTypeId: "14", contentId: "130376", name: "강동문화원" },
  { regionCode: "KR-JEJU-JEJUSI", regionNameKo: "제주시", expectedAreaCode: "39", expectedSigunguCode: "4", contentTypeId: "12", contentId: "1918950", name: "괴오름" },
  { regionCode: "KR-JEJU-JEJUSI", regionNameKo: "제주시", expectedAreaCode: "39", expectedSigunguCode: "4", contentTypeId: "14", contentId: "1939078", name: "조천읍도서관" },
  { regionCode: "KR-JEJU-SEOGWIPO", regionNameKo: "서귀포시", expectedAreaCode: "39", expectedSigunguCode: "3", contentTypeId: "12", contentId: "1884505", name: "가문이오름(감은이오름)" },
  { regionCode: "KR-JEJU-SEOGWIPO", regionNameKo: "서귀포시", expectedAreaCode: "39", expectedSigunguCode: "3", contentTypeId: "14", contentId: "130872", name: "제주국제평화센터" },
  { regionCode: "KR-SEOUL-CITY", regionNameKo: "서울", expectedAreaCode: "1", expectedSigunguCode: null as string | null, contentTypeId: "12", contentId: "2611568", name: "계남근린공원" },
  { regionCode: "KR-SEOUL-CITY", regionNameKo: "서울", expectedAreaCode: "1", expectedSigunguCode: null as string | null, contentTypeId: "14", contentId: "129927", name: "갤러리 서림" },
  { regionCode: "KR-JEJU-JEJUSI", regionNameKo: "제주시", expectedAreaCode: "39", expectedSigunguCode: "4", contentTypeId: "12", contentId: "129699", name: "금오름" },
  { regionCode: "KR-JEJU-JEJUSI", regionNameKo: "제주시", expectedAreaCode: "39", expectedSigunguCode: "4", contentTypeId: "14", contentId: "2834656", name: "아라리오뮤지엄 동문모텔2" },
  { regionCode: "KR-JEJU-SEOGWIPO", regionNameKo: "서귀포시", expectedAreaCode: "39", expectedSigunguCode: "3", contentTypeId: "12", contentId: "1887368", name: "각시바위오름" },
  { regionCode: "KR-JEJU-SEOGWIPO", regionNameKo: "서귀포시", expectedAreaCode: "39", expectedSigunguCode: "3", contentTypeId: "14", contentId: "2717330", name: "유민 아르누보 뮤지엄" },
  { regionCode: "KR-SEOUL-CITY", regionNameKo: "서울", expectedAreaCode: "1", expectedSigunguCode: null as string | null, contentTypeId: "12", contentId: "294505", name: "경국사(서울)" },
] as const;
...
async function main() {
  ...
  let gyenamCoordWarningConfirmed = false;

  const failureLog: string[] = [];

  console.log("=== PHASE 3-J-2 실행 시작 (place 단위 실패 격리, 25건 최대 처리) ===\n");
    ...
    if (commonOk) {
      ...
      if (!regionCheck.ok) {
        ...
        if (coordCheck.warnings.length > 0) {
          ...
          if (t.contentId === "2611568") gyenamCoordWarningConfirmed = true;
        }
  ...
  console.log(`계남근린공원(2611568) invalidCoordinate 확인: ${gyenamCoordWarningConfirmed ? "예" : "아니오(확인 필요)"}`);
